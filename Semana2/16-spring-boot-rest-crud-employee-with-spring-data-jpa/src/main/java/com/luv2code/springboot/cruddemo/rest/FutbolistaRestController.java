...
public class FutbolistaRestController {
    ...
    public Futbolista getFutbolista(@PathVariable int futbolistaId) {
    ...
    public Futbolista patchFutbolista(@PathVariable int futbolistaId,
    ...
    public String deleteFutbolista(@PathVariable int futbolistaId) {
        Futbolista tempFutbolista = futbolistaService.findById(futbolistaId);

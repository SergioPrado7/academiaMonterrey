...
* **01-Core-Avanzado**: Contiene los proyectos enfocados en buenas practicas de Java, inyeccion de dependencias, abstraccion y polimorfismo.
* **02-Spring-Security**: Abarca la configuracion de seguridad web, proteccion de rutas y autenticacion utilizando Keycloak.
...
Cada PDF fue elaborado especificamente para su proyecto y contiene la definicion de los conceptos tecnicos, la explicacion de los fragmentos de codigo mas importantes, la justificacion de las decisiones de diseno y las evidencias fotograficas que demuestran la correcta ejecucion de los programas y sus pruebas. 

Se recomienda abrir el documento PDF correspondiente al explorar los archivos de cada carpeta para obtener el contexto completo del problema que se resuelve.